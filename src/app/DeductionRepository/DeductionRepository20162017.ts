...
export class DeductionRepository20162017 extends DeductionRepository20152016
{
    ...
    getSection80C() : TaxSection{   
        ...
        section80C.deductions.push(new Deduction ( "80C" , "sukanyaSamridhi", true , 0 , "SS", "Deposit with Sukanya Samridhi Accounts"));
        return section80C;
    }
    ...
    getSection80CCD1B() : TaxSection { 
        ...
        section80CCD1B.deductions.push(
            new Deduction ( "80CCD1B" , "additionalNPS", true , 50000 , "ADDNPS", "Additional contribution towards NPS [u/s 80CCD(1B)]")
        );
    ...
    getSection80DD() : TaxSection{
        ...
        section80DD.deductions.push( 
            new Deduction ( "80DD" , "normal80DD" , true , 75000, "normal" , "Deduction for maintenance / medical treatment of dependent (u/s 80DD)"),
    ...
    getSection80U() : TaxSection{
        ...
        section80U.deductions.push( 
            new Deduction ( "80U", "normal80U" ,true, 75000, "normal" ,"Deduction in case of a person with disability (u/s 80U)" ),
            new Deduction ( "80U", "severe80U" ,true,50000, "severe" ,"Deduction in case of a person with disability (u/s 80U)" )
        );
        return section80U;
    }

    //Section 80EE should be removed in this year and 80DD, 80U are redefined and 80CCD1B is added
